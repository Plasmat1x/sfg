...
#pragma endregion
    ...
    Dyno player(b2Vec2(400.f, 300.f), b2Vec2(20.f, 40.f), world);
...
#pragma endregion
        ...
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space)) player.body->SetLinearVelocity(b2Vec2(player.body->GetLinearVelocity().x, -25.f));

        world.Step(1.f / 60.f, 16, 16);

        sprite.setPosition(ut::b2_to_sf(player.body->GetPosition()).x, ut::b2_to_sf(player.body->GetPosition()).y + 20.f);
